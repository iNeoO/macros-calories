...
export function getFemaleKcal(weight, height, old) {
  return (((9.74 * weight) + (172.9 * (height / 100))) - (4.737 * old)) + 667.051;
}
export function getMaleKcal(weight, height, old) {
  return (((13.707 * weight) + (492.3 * (height / 100))) - (6.673 * old)) + 77.607;
}
export function proteinGtoKcal(protein) {
  return Math.round(protein * 4);
}
export function carbohydrateGtoKcal(carbohydrate) {
  return Math.round(carbohydrate * 4);
}
export function fatGtoKcal(fat) {
  return Math.round(fat * 9);
}
export function proteinKcaltoG(protein) {
  return Math.round(protein / 4);
}
export function carbohydrateKcaltoG(carbohydrate) {
  return Math.round(carbohydrate / 4);
}
export function fatKcaltoG(fat) {
  return Math.round(fat / 9);
}
